#########################################################################
# chefe.s - Chefe da fase 3: a Bruxa Despedacada.
# A fase 3 e cortada por um rio de lava: a bruxa fica em cima (parada) e
# o mago embaixo. A bruxa lanca ossos na direcao da ultima posicao do
# mago. Ate 50 de HP: 1 osso/seg. A partir de 50: rajada de 3 a cada
# 1,5s. Textura muda entre parada (bruxa) e atacando (bruxa_atacando).
# 100 acertos matam (super = 5). Cada acerto enche +10 de mana.
# Autor: Jose Pedro Oliveira
#########################################################################
